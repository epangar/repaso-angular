...
export class CrudComponent implements OnInit {
  ...
  CrudDataBase: Array<DATA>  =[
    {name: "Alfredo", id: "1a2s3d4f5g", keywords:["alfa", "gold", "delta"], position: 1},
    {name: "Bernardo", id: "6h7j8k9l0a", keywords:["echo", "beta", "foxtrot"], position: 2},
    {name: "Carlos", id: "1l2k3j4h5g", keywords:["quebec", "romeo", "echo"], position: 3},
    {name: "Diana", id: "q2w3e4r5t6", keywords:["charlie", "tango", "foxtrot"], position: 4},
    ...
    {name: "Jerome", id: "m2n6b7v3c8", keywords:["junio", "kilo", "lambda"], position: 10},
    {name: "Kenny", id: "0n9j8d6x5q", keywords:["lambda", "junio", "iota"], position: 11},
  ]
